...
// POST /api/alerts
// Simula chamada de um sistema de monitorização
router.post("/", authRequired, async (req, res) => {
  ...
  try {
    ...
    const result = await pool
      .request()
      .input("title", sql.NVarChar, `Alerta ${service || "Sistema"} em ${host || "desconhecido"}`)
      .input("description", sql.NVarChar, message || "Alerta crítico de monitorização")
      ...
      .input("createdBy", sql.Int, 1) // por ex: user sistema
      .query(`
